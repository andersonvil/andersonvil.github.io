...
For a long time, economists studying how children influence parents’ work choices often overlooked this **income effect**. That’s where Olivier and me come in with a new study Donni and Vil (2024). We propose a structural model that considers both effects—the **substitution effect** and the **income effect**—to understand how having children impacts the number of hours parents choose to work.
